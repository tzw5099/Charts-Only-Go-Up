...
class FS:
    ...
    def __init__(self,subject,symbol):
        ...
        self.symbol = symbol
        csv_file = glob.glob("Charts_TenDollarDdata/financial_statements/data/Historical Financial Statements/*/year/{}/*_{}_*".format(self.subject,self.symbol))[-1] #.format("NLOK"))[-1]
