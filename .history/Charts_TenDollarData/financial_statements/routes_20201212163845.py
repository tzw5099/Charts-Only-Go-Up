...
company_profiles['lower symbol'] = company_profiles['short name'].apply(lambda x: x.lower())
...
profiles_dict = {}
url_symbol_name = company_profiles['lower symbol'].lower()+"/"+company_profiles['lower short name']
short_name = ["log", "cash_and_cash_equivalents","current_ratio_not_gonna_work", "loginexample"]

print("BOO HOOs",url_symbol_name[1],url_symbol_name[1].split("/")[0].upper())
