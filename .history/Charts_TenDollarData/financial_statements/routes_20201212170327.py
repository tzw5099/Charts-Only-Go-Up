...
@charts.route('/<urilist>/<some_place>/dzs', methods=['POST', 'GET']) # WORKS
@charts.route('/<some_place>-stock/<name_url>/<urilist>/<dd>/dzs', methods=['POST', 'GET']) # WORKS
# @charts.route('/<some_place>/<name_url>/<urilist>/dzs', methods=['POST', 'GET']) # WORKS
...
# @cache.cached(timeout=5)
def current_ratio(urilist,name_url,some_place,dd): # WORKS
