...
@charts.route('/<url_symbol>-stock/<url_name>/<financial_statement>/<url_fin_metric>', methods=['POST', 'GET']) # WORKS
def current_ratio(url_fin_metric,url_name,financial_statement,url_symbol): # WORKS
