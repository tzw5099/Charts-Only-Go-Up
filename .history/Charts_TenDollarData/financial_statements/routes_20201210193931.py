...
def financial_statements(some_place):
    ...
    start_time = time.time()
    csv_file = glob.glob("Charts_TenDollarData/Historical Financial Statements/data/Historical Financial Statements/*/year/Income Statement/*_{}_*".format(some_place))[-1] #.format("NLOK"))[-1]
    df = pd.read_csv(csv_file)
