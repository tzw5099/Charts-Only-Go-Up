...
def current_ratio(urilist,some_place):
    ...
    start_time = time.time()
    csv_file = glob.glob("Charts_TenDollarData/financial_statements/data/Historical Financial Statements/*/year/Balance Sheet/*~{}~*".format(some_place))[-1]
    ...
    values = list(df['Cash and Cash Equivalents'])#[0:19]
