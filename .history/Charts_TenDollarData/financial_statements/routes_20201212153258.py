...
@charts.route('/<some_place>/<urilist>/d', methods=['POST', 'GET'])
# @charts.route('/<some_place>/<urilist>', methods=['POST', 'GET'])

# company_name_url = company_profiles[company_profiles['symbol']=="{}".format(some_place)]
s = pd.read_csv("reference_Data/Company_Profiles.csv")#, encoding='cp1252')
    ...
    profiles_dict = {}
    profiles_value = company_profiles[company_profiles['symbol']=="{}".format(some_place)].values.tolist()[0]
