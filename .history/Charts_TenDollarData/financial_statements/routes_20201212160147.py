...
company_profiles['lowercase short name'] = company_profiles['short name'].apply(lambda x: x.lower())
short_name = list(company_profiles['lowercase short name'])
profiles_dict = {}
short_name = company_profiles
...
# @cache.cached(timeout=5)
def current_ratio(urilist,short_name,some_place):
