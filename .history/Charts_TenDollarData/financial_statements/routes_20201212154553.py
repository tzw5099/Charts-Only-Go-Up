...
@charts.route('/<some_place>-stock/<urilist>/d', methods=['POST', 'GET'])
...
def current_ratio(urilist,some_place):
    ...
    # MARK: asdas
    start_time = time.time()
    csv_file = glob.glob("Charts_TenDollarData/financial_statements/data/Historical Financial Statements/*/year/{}/*~{}~*".format(fin_statement_dir, upper(some_place)))[-1]
