...
def metric_to_list_variables_map(df,metric):
    metric_to_list_variables_map = {
        ...
        'quick_ratio':[total_current_liabilities,]
        'working_capital':[total_current_assets  total_current_liabilities,]
        'current_ratio':[total_current_liabilities,]
        ...
        'free_operating_cash_flow_to_debt':[operating_cash_flowcapex,total_debt,]
        'discretionary_cash_flow_to_debt':[operating_cash_flowaccounts_payabledebt_repaymentdividends_paidinterest_expense,]
        ...
        'operating_margin':[ebitda_nond_a,net_revenue,]
        ...
        'dividend_yield':[dividends_paidprice_market,shares_outstanding_non,]
