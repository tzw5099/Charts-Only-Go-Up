	...
	return (function () {
		...
		return (
			...
			b.mixin(c.prototype, {
				...
				get: function (a) {
					return (
						(a = b.isArray(a) ? a : [].slice.call(arguments)), this.index.get(a)
					);
				},
		...
		var b = (function () {
			...
			f = (function (a) {
				...
				var e = {
					...
					f = {
						A:
							"[AaªÀ-Åà-åĀ-ąǍǎȀ-ȃȦȧᴬᵃḀḁẚẠ-ảₐ℀℁℻⒜Ⓐⓐ㍱-㍴㎀-㎄㎈㎉㎩-㎯㏂㏊㏟㏿Ａａ]",
						B: "[BbᴮᵇḂ-ḇℬ⒝Ⓑⓑ㍴㎅-㎇㏃㏈㏔㏝Ｂｂ]",
						C: "[CcÇçĆ-čᶜ℀ℂ℃℅℆ℭⅭⅽ⒞Ⓒⓒ㍶㎈㎉㎝㎠㎤㏄-㏇Ｃｃ]",
						...
						I:
							"[IiÌ-Ïì-ïĨ-İĲĳǏǐȈ-ȋᴵᵢḬḭỈ-ịⁱℐℑℹⅈⅠ-ⅣⅥ-ⅨⅪⅫⅰ-ⅳⅵ-ⅸⅺⅻ⒤Ⓘⓘ㍺㏌㏕ﬁﬃＩｉ]",
						J: "[JjĲ-ĵǇ-ǌǰʲᴶⅉ⒥ⒿⓙⱼＪｊ]",
						K: "[KkĶķǨǩᴷᵏḰ-ḵK⒦Ⓚⓚ㎄㎅㎉㎏㎑㎘㎞㎢㎦㎪㎸㎾㏀㏆㏍-㏏Ｋｋ]",
						...
						update: function (b) {
							function c(a) {
								g ||
									...
									h < e.limit &&
										e.async &&
										e.trigger("asyncRequested", b, e.name));
							}
							function d(c) {
								if (((c = c || []), !f && h < e.limit)) {
									e.cancel = a.noop;
							...
							this.cancel(),
								(this.cancel = function () {
									(f = !0),
										(e.cancel = a.noop),
										e.async && e.trigger("asyncCanceled", b, e.name);
								}),
								this.source(b, c, d),
								!g && c([]);
						},
					...
					b.mixin(c.prototype, {
						...
						autocomplete: function (a) {
							...
							return (
								...
								!(
									!(c && b !== c.val) ||
									this.eventBus.before("autocomplete", c.obj, c.dataset)
								) &&
