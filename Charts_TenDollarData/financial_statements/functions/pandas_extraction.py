...
class FS:
    ...
    def __init__(self,subject,symbol):
        ...
        self.symbol = symbol
        csv_file = glob.glob("D:\\Cloud\\rclone\\OneDrive\\Web\\TenDollarData\\Charts_TenDollarData\\financial_statements\\data\\Historical Financial Statements\\*\\year\\{}\*_{}_*".format(self.subject,self.symbol))[-1] #.format("NLOK"))[-1]
...
subject="Income Statement"
symbol="AAPL"
csv_file = glob.glob("D:\\Cloud\\rclone\\OneDrive\\Web\\TenDollarData\\Charts_TenDollarData\\financial_statements\\data\\Historical Financial Statements\\*\\year\\{}\\*_{}_*".format(subject,symbol))[-1]
